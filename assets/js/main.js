...
(function () {
 ...
 if (wx) {
 fetch('https://api.open-meteo.com/v1/forecast?latitude=49.888&longitude=-119.496&current=temperature_2m,wind_speed_10m,weather_code&timezone=America%2FVancouver').then(r => r.json()).then(d => {
 ...
 msg = `<strong>Lake- season</strong> — kokanee season opens in ${daysToKokanee} days`;
 } else {
